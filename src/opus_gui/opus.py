...
def main():
    # if 'PYTHONPATH' in os.environ:
        # if 'src' not in os.environ['PYTHONPATH']:
            # os.environ['PYTHONPATH'] = os.environ['PYTHONPATH'] + ';C:\\opus\\src'
    # if 'PYTHONPATH' not in os.environ:
        # os.environ['PYTHONPATH'] = 'C:\\opus\\src'
    # if 'OPUS_HOME' not in os.environ:
        # os.environ['OPUS_HOME'] = 'C:\\opus'
    # if 'OPUS_DATA_PATH' not in os.environ:
        # os.environ['OPUS_DATA_PATH'] = 'C:\\opus\\data'
    # if 'C:\\opus\\src' not in sys.path:
        # sys.path.append('C:\\opus\\src')
    ...
    app.setApplicationName("URBANSIM2- Draft 1")
