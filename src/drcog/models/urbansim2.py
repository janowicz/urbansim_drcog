...
########ESTIMATION
        ...
        # if core_components_to_run['HLCM']:
            # print 'HLCM'
            # logger.log_status('HLCM estimation.')
            # ##HCLM ESTIMATION
            ...
            # ind_vars1=['ln_dist_rail','ln_avg_unit_price_zone','median_age_of_head','mean_income','median_yearbuilt_post_1990','median_yearbuilt_pre_1950','proportion_hh_contain_kids_if_hh_contains_kids','percent_renter_hh_in_zone',
                       # 'townhome','multifamily','cherry_creek_school_district','zone_contains_park','percent_younghead_if_younghead','ln_jobs_within_30min']
            ...
            # for name, segment in segments:
                ...
                # #alternative_sample['hh_income_x_average_unit_size'] = ((alternative_sample.income)*alternative_sample.average_resunit_size)
        ...
        # if core_components_to_run['ELCM']:
            # print 'ELCM'
            # logger.log_status('ELCM estimation.')
            # #ELCM ESTIMATION
            ...
            # ind_vars1=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector1_within_15min']
            # ind_vars2=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector2_within_15min']
            # ind_vars3=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector3_within_15min']
            # ind_vars4=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector4_within_15min']
            # ind_vars5=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector5_within_15min']
            # ind_vars6=['ln_jobs_within_30min','ln_avg_nonres_unit_price_zone','median_year_built','residential_units_zone','ln_pop_within_20min',
                       # 'office','retail_or_restaurant','industrial_building','employees_x_non_residential_sqft_zone','ln_emp_sector6_within_15min']
        ...
        # if core_components_to_run['Developer']:
            # if not developer_configuration['Proforma']:
                # print 'RDPLCM'
                # logger.log_status('RDPLCM estimation.')
                # ##RDPLCM ESTIMATION
                ...
                # ###########################
                # print 'NRDPLCM'
                # logger.log_status('NRDLCM estimation.')
                # ##NRDPLCM ESTIMATION
        ...
        ############     REPM SIMULATION   ####Uncomment this stuff when it works with the proforma developer model (There's that weird interaction where non-res proforma crashes with price models on)
                ...
                if export_indicators:
                    ...
                    if sim_year == last_year:
                        ...
                        ######
                        csumm.to_csv(os.path.join(indicator_output_directory,'county_summary.csv'))
                        zsumm.to_csv(os.path.join(indicator_output_directory,'zone_summary.csv'))
